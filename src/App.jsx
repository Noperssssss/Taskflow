...
setContractInput(””); setShowAddContract(false); flash(“Added to contract checklist ✓”);
}
...
function resetContractChecks() { saveContract(contractItems.map(i=>({…i,checked:false}))); setShowResetConfirm(false); flash(“Checklist reset ✓”); }
